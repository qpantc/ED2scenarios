...
for (i_row in seq(1,nrow(site_list_df))) {
  ...
  name_scenar <- paste("simulation",site_id,year_a,year_z,sep = '_')
  ...
  # set
  css_file = csspss_file_list[startsWith(csspss_file_list,paste0(site_id,'_'))][1]
  ...
  system2("cp",c(paste0(pft_xml_path,site_id,'_mean',".xml"),
